...
const Register = function () {
    ...
    useEffect(() => {
        if (sessionStorage.getItem("transformatec-token")) {
          router.push("/home");
      }
    }, []);
    ...
    return (
        <>
            <Head>
                <title>Transformatec - Registro</title>
            ...
            <HeaderGeneric logoUrl="/" btnUrl="/login" btnContent="Quero fazer login" />
                <Container>
                    <p className={styles.formTitle}>Bem-vindo(a) ao TransformaTec!</p>
                    <Form className={styles.form} onSubmit={handleRegister}>
                        <p className="text-center">
                            <strong>Bem-vindo(a) ao TransformaTec!</strong>
                        </p>
                        <FormGroup>
